...
extension Ligand {
    ...
    private func elementColor(for element: String) -> UIColor {
        let colors: [String: UIColor] = [
            "H": .white,
            "C": UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1.0),      // Gray
            "N": UIColor(red: 0.2, green: 0.3, blue: 1.0, alpha: 1.0),      // Blue
            "O": UIColor(red: 1.0, green: 0.2, blue: 0.2, alpha: 1.0),      // Red
            "S": UIColor(red: 1.0, green: 1.0, blue: 0.2, alpha: 1.0),      // Yellow
            "P": UIColor(red: 1.0, green: 0.5, blue: 0.0, alpha: 1.0),      // Orange
            "F": UIColor(red: 0.3, green: 1.0, blue: 0.3, alpha: 1.0),      // Light green
            "CL": UIColor(red: 0.2, green: 0.8, blue: 0.2, alpha: 1.0),     // Green
            "BR": UIColor(red: 0.6, green: 0.2, blue: 0.2, alpha: 1.0),     // Dark red
            "I": UIColor(red: 0.5, green: 0.0, blue: 0.5, alpha: 1.0),      // Purple
            "FE": UIColor(red: 0.9, green: 0.5, blue: 0.0, alpha: 1.0),     // Orange-brown
            "CA": UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1.0),     // Gray
            "MG": UIColor(red: 0.0, green: 0.7, blue: 0.0, alpha: 1.0),     // Green
            "ZN": UIColor(red: 0.5, green: 0.5, blue: 0.7, alpha: 1.0),     // Blue-gray
            "NA": UIColor(red: 0.0, green: 0.0, blue: 1.0, alpha: 1.0),     // Blue
            "K": UIColor(red: 0.5, green: 0.0, blue: 0.5, alpha: 1.0),      // Purple
            "SE": UIColor(red: 1.0, green: 0.6, blue: 0.0, alpha: 1.0)      // Orange
        ]
