...
/// Van der Waals radii — delegates to PDBKit's VanDerWaalsRadii (single source of truth).
public struct VanDerWaalsRadii {
    public static var radii: [String: Float] { PDBKit.VanDerWaalsRadii.radii }

    public static func radius(for element: String) -> Float {
        return PDBKit.VanDerWaalsRadii.radius(for: element)
    }
}
